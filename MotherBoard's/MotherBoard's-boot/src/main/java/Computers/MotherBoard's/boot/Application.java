package Computers.MotherBoard's.boot;
...
@SpringBootApplication(scanBasePackages = {"Computers.MotherBoard's.boot.components",
                                           "Computers.MotherBoard's.application.service",
                                           "io.gumga",
                                           "Computers.MotherBoard's.api"})
@EnableJpaRepositories(repositoryFactoryBeanClass = GumgaRepositoryFactoryBeanForSpringBoot.class, basePackages = {"Computers.MotherBoard's.application.repository", "io.gumga"})
...
public class Application {
    ...
    public DataSource dataSource() {
        ...
        config.addDataSourceProperty("url", getProperties().getProperty("dataSource.url", "jdbc:h2:mem:MotherBoard's;MVCC=true"));
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(DataSource dataSource) {
        ...
        factory.setPackagesToScan("io.gumga.domain", "Computers.MotherBoard's.domain.model");
