 ...
 */
package Computers.codeg.generator.processor;

import Computers.codeg.generator.Constants;
...
public class ApiWorldResponseProcessor extends BaseResponseProcessor {
  ...
  static String DEFAULT_RESPONSE_CLASS_NAME = "Computers.vo.ResultModel";

  static String DEFAULT_LISTRESPONSE_CLASS_NAME = "Computers.vo.ResultListModel";

  static String DEFAULT_PAGERESPONSE_CLASS_NAME = "Computers.vo.ResultPageModel";

  static String DEFAULT_RESPONSE_HELPER_CLASS_NAME = "Computers.helper.ResultHelper";
